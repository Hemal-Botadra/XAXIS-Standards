# Xaxis Javascript Style Guide

Influenced by Airbnb'sJavascript style guide.

> **Note**: this guide assumes you are using [Babel](https://babeljs.io). Or the Angular 4 CLI to compile your TypeScript/ES6 Syntax.
